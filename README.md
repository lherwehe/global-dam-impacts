...
### Notebooks
* exploration-notebooks/dam-impacts-on-protected-areas-calc.ipynb: A JupyterNotebook that (1) contains functions that combine World Database of Protected Areas and Ramsar Data for a country or continent to create a full protected areas dataset for the desired region and (2) calculates the total length of rivers on protected lands and total area of protected lands that are affected by proposed dams by country for a desired continent. 
* exploration-notebooks/dam-impacts-on-protected-areas-visualization.ipynb: A JupyterNotebook that creates three example maps for Burkina Faso, with all rivers stratified by Degree of Regulation, (1) all current rivers and protected areas, (2) all current rivers that overlap protected areas, and (4) all projected future rivers that overlap protected areas. It also provides (4) all current rivers and protected areas in all Africa by Degree of Regulation.
